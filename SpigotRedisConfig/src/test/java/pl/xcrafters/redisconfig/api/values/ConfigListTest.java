...
public class ConfigListTest {
    ...
    public void testList() {
        ...
        ConfigList<SpigotConfigMaterial> materials = new ConfigList<SpigotConfigMaterial>(Arrays.asList(new SpigotConfigMaterial(Material.ACACIA_DOOR), new SpigotConfigMaterial(Material.ACACIA_BUTTON), new SpigotConfigMaterial(Material.ACACIA_FENCE)));
